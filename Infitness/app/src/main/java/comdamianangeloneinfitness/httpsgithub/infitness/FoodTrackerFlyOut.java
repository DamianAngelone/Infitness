...
public class FoodTrackerFlyOut extends LinearLayout {
...
//			new SmoothInterpolator());
    ...
    public FoodTrackerFlyOut(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public FoodTrackerFlyOut(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FoodTrackerFlyOut(Context context) {
        super(context);
    }
    ...
    protected class AnimationRunnable implements Runnable {
        ...
        @Override
        public void run() {
            FoodTrackerFlyOut.this
                    .adjustContentPosition(FoodTrackerFlyOut.this.menuAnimationScroller
                            .computeScrollOffset());
        }
